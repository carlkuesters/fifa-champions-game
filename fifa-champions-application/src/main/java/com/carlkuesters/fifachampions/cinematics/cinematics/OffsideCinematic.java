...
public class OffsideCinematic extends Cinematic {
    ...
    protected void initialize(SimpleApplication simpleApplication) {
        ...
        addPart(new CinematicPart(1.5f, new AttachSpatialAction(rootNode, line)));
        addPart(new CinematicPart(1.5f, new AlphaFadeAction(lineMaterial, 0, 1, 1)));
        addPart(new CinematicPart(5, new AlphaFadeAction(lineMaterial, 1, 0, 1)));
        addPart(new CinematicPart(6, new DetachSpatialAction(line)));
    }
}
